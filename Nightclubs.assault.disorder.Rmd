...
```{r create arrests per tract and liquor locations per tract, join to}
...
reg.mod = as.formula(CATEGORY ~TYPE)
mod.OLS = lm(reg.mod, data = join_sp)



EUDM <- gw.dist(coordinates(arrests_sp))
