...
write.csv(liquor, "./datasets/cleaned/liquor.cleaned.csv")
write.csv(arrests, "./datasets/cleaned/arrests.cleaned.csv")
...
st_write(tracts_shp, "./datasets/cleaned/tracts.cleaned_shp", driver="ESRI Shapefile") 
...
st_write(arrests_sf, "./datasets/cleaned/arrests.cleaned_sf", driver="ESRI Shapefile") 
st_write(liquor_sf, "./datasets/cleaned/liquor.cleaned_sf", driver="ESRI Shapefile") 
...
acs<-subset(acs, select=c("med_hh_income", "TRACT", "males_25_29"))
...
In the spatially lagged model, variables significant at the 10% level are the same as in the OLS model: 
