...
Moran's I is significant for NE DC, which suggests we may want to run two spatially lagged models, one for all of DC and one for NE DC in particular. SW DC has an NA p-value perhaps because it has two few tracts. 
